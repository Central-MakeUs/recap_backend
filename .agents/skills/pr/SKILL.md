...
- 기본 Assignee: RECAP의 기본 담당자는 아직 정해지지 않았으니, 확정 전까지는
  **Assignee를 비워두지 말고 사용자에게 매번 묻는다.**
- Label 목록: RECAP 저장소의 실제 라벨은 `gh label list --limit 100`으로
  확인 후 사용한다.
